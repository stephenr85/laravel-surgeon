...
use Rushing\Surgeon\Console\EnvCommand;
 ...
 * check by default, `--fix` as a separate reformat write-op; also a gate stage-4), and the environment
 * inventory {@see EnvCommand} (every env var the tree reads or declares, reconciled against
 * `.env.example` and `.env`).
